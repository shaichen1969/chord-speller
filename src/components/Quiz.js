...
const Quiz = () => {
    const quizModes = [
        ...
        { name: 'Random 3-Note Chords', description: 'Practice random three-note chords.', path: '/play/quiz/random3' },
        { name: 'Random 4-Note Chords', description: 'Practice random four-note chords.', path: '/play/quiz/random4' },
        { name: 'Random 5-Note Chords', description: 'Practice random five-note chords.', path: '/play/quiz/random5' },
        { name: 'Major Scales', description: 'Practice major scales.', path: '/play/quiz/majorScale' },
    ];
