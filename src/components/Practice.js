...
const Practice = () => {
    const practiceModes = [
        ...
        { name: 'Triads', description: 'Practice basic three-note chords.', path: '/play/practice/triad' },
        { name: '7th Chords', description: 'Practice four-note seventh chords.', path: '/play/practice/seventh' },
        { name: 'Basic Tension', description: 'Practice triads with an added tension note.', path: '/play/practice/triadPlusTension' },
        { name: 'Jazz Chords', description: 'Challenge yourself with complex jazz chord structures.', path: '/play/practice/jazzChords' },
        { name: 'Random 4-Note Chords', description: 'Practice random four-note chords.', path: '/play/practice/random4' },
        { name: 'Random 5-Note Chords', description: 'Practice random five-note chords.', path: '/play/practice/random5' }
