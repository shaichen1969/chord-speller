        ...
        <div className="documentation-overlay">
            <div className="documentation-content">
                ...
                <div className="documentation-text">
                    ...
                    <h3>How the Chord Spelling Master Analyzes Chords</h3>
                    <p>The Chord Spelling Master performs a comprehensive analysis of chords to identify the most stable combinations:</p>
                    ...
                    <p>This approach allows the Chord Spelling Master to provide a comprehensive analysis of any given chord, offering insights into its structure from multiple perspectives and presenting the most musically relevant interpretation.</p>

                    <h3>How to Read Chord Symbols</h3>
                    <p>Chord symbols in the Chord Spelling Master are designed to be informative easy to understand and denote missing overtones within chords:</p>
                    ...
                    <h3>Settings</h3>
                    <p>The settings dialog allows you to customize various aspects of the Chord Spelling Master to suit your preferences and training needs.</p>
