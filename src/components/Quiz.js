...
const Quiz = () => {
    const quizModes = [
        ...
        { name: 'Random 3-Note Chords', description: 'Practice constructing random three-note chords.', path: '/play/quiz/random3' },
        { name: 'Random 4-Note Chords', description: 'Practice constructing random four-note chords.', path: '/play/quiz/random4' },
        { name: 'Random 5-Note Chords', description: 'Practice constructing random five-note chords.', path: '/play/quiz/random5' },
        { name: 'Major Scales', description: 'Practice constructing major scales.', path: '/play/quiz/majorScale' },
    ];

    return (
        <div className="quiz-page">
            <h1 className="quiz-title">Chord constructing Quiz</h1>
